...
{
	int respuesta = 0; //Variable que representa la respuesta del menu inicial
	...
	do{
		...
		case 1:{
			...
			cout<<"Mientras platican el te cuenta que le gusta mucho la naturaleza y su signo zodiacal es Leo"<<endl;
			cout<<"Piensas que es el hombre de tus sueños..."<<endl;
			...
			cout<<"Te propone ir a tomar algo tranqui y despues al cine a ver una pelicula"<<endl;
			...
			switch(respuestaCinco){
				...
				default:
					...
					}else if(atractivo<80&&atractivo>40){
